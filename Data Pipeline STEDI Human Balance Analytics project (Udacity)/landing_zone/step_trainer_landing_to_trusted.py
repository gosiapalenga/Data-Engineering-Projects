...
accelerometerlanding_node1713454143771 = glueContext.create_dynamic_frame.from_options(format_options={"multiline": False}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-project-bucket-282192/accelerometer/landing/"], "recurse": True}, transformation_ctx="accelerometerlanding_node1713454143771")

# Script generated for node customer landing
customerlanding_node1713454113747 = glueContext.create_dynamic_frame.from_options(format_options={"multiline": False}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-project-bucket-282192/customer/landing/"]}, transformation_ctx="customerlanding_node1713454113747")

# Script generated for node SQL Query
SqlQuery0 = '''
SELECT s.*
FROM step_trainer_landing s
JOIN accelerometer_landing a ON s.sensorreadingtime = a.timestamp
JOIN customer_landing c ON c.serialnumber = s.serialnumber AND a.timestamp = s.sensorreadingtime
WHERE c.sharewithresearchasofdate IS NOT NULL;
'''
SQLQuery_node1713454183322 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"step_trainer_landing":steptrainerlanding_node1713454064577, "customer_landing":customerlanding_node1713454113747, "accelerometer_landing":accelerometerlanding_node1713454143771}, transformation_ctx = "SQLQuery_node1713454183322")
